...
switch ($opcion) {
    ...
    case 3:
		switch ($operation) {
			case "add":
				echo HerramientasAdd( $name, $idcategoria, $idubicacion1, $idubicacion2, $idubicacion3, $cantidad );
			case "edit":
				echo HerramientasEdit( $id, $name, $idcategoria, $idubicacion1, $idubicacion2, $idubicacion3, $cantidad );
			case "del":
				echo HerramientasDel( $id );
			case "rep":
				echo ReparacionAdd( $id, $problema, $cantidad  );
		}		
		break;
}
